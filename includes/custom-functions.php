...
class custom_functions
{
    ...
    public function get_seller_address($seller_id)
    {
        ...
        $pincode_text = (!empty($res_seller[0]['pincode_text'])) ? $res_seller[0]['pincode_text'] . ", " : "";
        $city_text = (!empty($res_seller[0]['city_text'])) ? $res_seller[0]['city_text'] . ", " : "";
        //$pincode = (!empty($res_seller[0]['pincode_id'])) ? $city_name . $res_pincode[0]['pincode'] : "";
        $seller_address = $state  . $street . $city_text . $pincode_text;
