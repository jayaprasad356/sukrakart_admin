                                        ...
                                        <form id="update_form">
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select disabled name='delivery_boy_id' class='form-control deliver_by' required>
                                                ...
                                                <?php if (count($items) > 6) { ?>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select disabled name='delivery_boy_id_bottom' class='form-control deliver_by' required>
                                                                    <option value=''>Select Delivery Boy</option>
